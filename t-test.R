...
# Дисклеймер: во многих русскоязычных статьях пишут о том, что данные должны быть распределены нормально,
# но это не совсем так. ЦПТ требует нормальности распределения выборочных средних.
# Корень проблемы в ошибке перевода на википедии, подробнее можно ознакомиться в этой статье:
